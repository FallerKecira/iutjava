...
public class ApplicationLogsTest {
	...
	public void testApplicationErrorLog() {
		...
		{
			System.err.println("get or set message not working in ApplicationErrorLog ");
		}
		...
		{
			System.err.println("get or set listeners not working in ApplicationErrorLog ");
		}
	...
	public void testApplicationWarningLog() {
		...
		if(!(test.getMessage().equals("test")))
		{
			System.err.println("get or set message not working in ApplicationWarningLog ");
		}
		...
		if( test.getApplicationLogListeners().size() != 1 )
		{
			System.err.println("get or set listeners not working in ApplicationWarningLog ");
		}
	...
	public void testApplicationInfoLog() {
		...
		if(!(test.getMessage().equals("test")))
		{
			System.err.println("get or set message not working in ApplicationInfoLog ");
		}
		...
		if( test.getApplicationLogListeners().size() != 1 )
		{
			System.err.println("get or set listeners not working in ApplicationInfoLog ");
		}
	...
	public void testApplicationLog() {
		...
		{
			System.err.println("error at getErrors");
		}
		if(tests.getWarnings().size()!=2)
		{
			System.err.println("error at getwarnings");
		}
		if(tests.getInfos().size()!=1)
		{
			System.err.println("error at getInfos");
		}
